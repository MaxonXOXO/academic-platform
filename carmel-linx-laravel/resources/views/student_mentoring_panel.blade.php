    ...
    <div class="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left w-full md:w-auto">
      <div class="flex-shrink-0">
        <div id="diaryStudentPhotoContainer">
          ...
          @else
            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center font-black text-xl text-white shadow-lg border border-blue-500/30">
      ...
      <div class="flex-grow space-y-1">
        <div class="flex flex-col sm:flex-row sm:items-center justify-center sm:justify-start gap-2">
          ...
          <span class="px-2.5 py-0.5 rounded-full text-[10px] text-xs font-bold uppercase tracking-wider bg-blue-500/10 text-blue-400 border border-blue-500/20 self-center">
            Active Student
          </span>
        </div>
  ...
  <div class="w-full bg-slate-950/30 border border-slate-800/40 rounded-2xl p-6 min-h-[400px]">
      ...
      <div id="smdBoard" class="smd-content-pane hidden space-y-4">
        ...
        <div class="flex justify-end mt-4">
          <button onclick="saveStudentMentoringData()" class="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium transition-premium cursor-pointer flex items-center gap-1.5 shadow-sm text-xs">
      ...
      <div id="smdExtra" class="smd-content-pane hidden space-y-4">
        <div class="flex justify-between items-end border-b border-slate-800 pb-3">
            ...
            <button onclick="openStudentActivityModal()" class="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-medium transition-premium cursor-pointer flex items-center gap-1"><span class="material-symbols-rounded text-xs">add</span> Add Activity</button>
        </div>
        ...
        <div class="overflow-x-auto rounded-xl border border-slate-800/60">
          <table class="w-full text-left text-xs border-collapse">
            ...
            <tbody id="smdExtraTable" class="text-slate-300">
              <tr><td colspan="6" class="p-6 text-center text-slate-500">No activity records found.</td></tr>
            </tbody>
          </table>
        </div>
      </div>
      ...
      <div id="smdLeave" class="smd-content-pane hidden space-y-4">
        <div class="flex justify-between items-center border-b border-slate-800/60 pb-2 mb-4">
            <h4 class="font-semibold text-slate-200 text-xs uppercase tracking-wider">Leave Records</h4>
            <button onclick="openLeaveModal()" class="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-medium transition-premium cursor-pointer flex items-center gap-1 text-xs">
        ...
        <div class="overflow-x-auto bg-slate-900/50 border border-slate-700 rounded-xl">
          <table class="w-full text-left text-xs">
            <thead class="bg-slate-800/80 text-slate-400 font-semibold uppercase text-xs">
              <tr>
...
<div id="addStudentActivityModal" class="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[70] hidden items-center justify-center p-4">
  <div class="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 shadow-2xl">
    <div class="flex justify-between items-center mb-6">
      <h3 class="text-xs font-bold text-white" id="studentActivityModalTitle">Add Activity</h3>
    ...
    <form id="studentActivityForm" onsubmit="saveStudentActivity(event)">
      ...
      <div class="space-y-4">
        <div>
          <label class="block text-sm font-semibold text-slate-400 mb-1">Semester</label>
        ...
        <div>
          <label class="block text-sm font-semibold text-slate-400 mb-1">Segment</label>
        ...
        <div>
          <label class="block text-xs font-semibold text-slate-400 mb-1">Activity Name</label>
        ...
        <div>
          <label class="block text-xs font-semibold text-slate-400 mb-1">Level (e.g. State, College)</label>
        ...
        <div>
          <label class="block text-xs font-semibold text-slate-400 mb-1">Points Claimed</label>
    ...
    <form id="leaveForm" onsubmit="saveLeave(event)">
      ...
      <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block font-semibold text-slate-400 mb-1 text-sm">Semester</label>
          ...
          <div>
            <label class="block font-semibold text-slate-400 mb-1 text-sm">From Date</label>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block font-semibold text-slate-400 mb-1 text-sm">To Date</label>
          ...
          <div>
            <label class="block font-semibold text-slate-400 mb-1 text-sm">No. of Days</label>
        ...
        <div>
          <label class="block font-semibold text-slate-400 mb-1 text-sm">Reason</label>
        ...
        <button type="submit" class="w-full py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium text-sm shadow-sm">Save Leave Record</button>
      </div>
    </form>
  </div>
</div>
