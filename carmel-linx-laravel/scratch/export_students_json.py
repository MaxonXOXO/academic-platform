...
with open('/home/carmel/Downloads/Carmel-linx/academic-platform/carmel-linx-laravel/scratch/parsed_s5_students.json', 'w') as f:
    json.dump(payload, f, indent=2)

print(f"Exported {len(ce_students)} CE students and {len(ct_students)} CT students to parsed_s5_students.json")
